...
public class ModEntityTypeDataMapProvider extends EntityTypeDataMapProvider {
  public ModEntityTypeDataMapProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registryLookup) {
